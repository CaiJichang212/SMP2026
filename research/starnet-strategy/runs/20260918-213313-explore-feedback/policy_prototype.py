...
class ObservationBook:
    ...
    def candidates(self, budget):
        ...
        if self.nodes[target]['comm_left'] > 0 and len(measured) < 3:
        ...
        # At most two options per node, so multiple distinct targets remain visible.
        return 'intervene', candidates[:16], 4
